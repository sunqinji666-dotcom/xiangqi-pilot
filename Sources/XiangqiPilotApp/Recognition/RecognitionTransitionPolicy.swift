...
enum RecognitionTransitionPolicy {
    ...
    /// Stub – always nil. Multi-cell decorated paths are no longer accepted.
    ...
    /// Stub – always nil. Strict two-endpoint verification only.
    ...
    /// Stub – always nil. Two-ply decorated replies are no longer accepted.
