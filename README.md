...
![Tests](https://img.shields.io/badge/tests-81%20passing-22C55E?style=flat-square)
...
| 场景 | 用大白话解释 |
| --- | --- |
| 中国象棋 | 识别棋盘和棋子，按中国象棋规则判断走法，再调用内置引擎或 Pikafish 分析 |
